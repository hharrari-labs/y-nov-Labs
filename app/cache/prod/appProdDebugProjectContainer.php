...
class appProdDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'http://serveur.zman-officiel.com', 'port' => '443', 'dbname' => 'y-nov-labs', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->setProxyDir('C:/wamp/www/y-nov/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => 'http://serveur.zman-officiel.com',
            'database_port' => '443',
